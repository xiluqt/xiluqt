(function(){
  ...
  window.addEventListener('DOMContentLoaded',()=>{installStatus();['w','c','i','f'].forEach(id=>{const e=document.getElementById(id);if(e)e.addEventListener('input',()=>setTimeout(render,0));});const api=document.getElementById('apiRun');if(api)api.addEventListener('click',()=>setTimeout(render,0));setTimeout(render,0);syncSources();schedule();});
})();
