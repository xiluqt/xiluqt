...
function wire(){
 ...
 const api=document.getElementById('apiRun');if(api&&!api.dataset.feedbackWired){api.dataset.feedbackWired='1';api.addEventListener('click',()=>recordPrediction('api-preview'))}
...
window.XiluqtFeedback={recordPrediction,addOutcome,exportJSONL};
